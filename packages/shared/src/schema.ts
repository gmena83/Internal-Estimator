...
export const projects = pgTable("projects", {
  ...
  status: text("status").notNull().default(PROJECT_STATUS.DRAFT), // draft, estimate_generated, assets_ready, email_sent, accepted, in_progress, completed
...
export const imageApprovalSchema = z
  .object({
