...
describe("ActionButtons Component", () => {
  ...
  describe("Stage 1 Actions", () => {
    it("should show parse and analyze button at stage 1", () => {
      ...
      const button = <button data-testid="btn-parse">Parse & Analyze</button>;
    ...
    it("should show generate estimate button after parsing", () => {
      ...
      const button = <button data-testid="btn-estimate">Generate Estimate</button>;
  ...
  describe("Stage 2 Actions (Estimate Approval)", () => {
    it("should show approve estimate button at stage 2", () => {
      ...
      const button = <button data-testid="btn-approve">Approve Estimate</button>;
  ...
  describe("Reset Project Action", () => {
    it("should show reset button", () => {
      const button = <button data-testid="btn-reset">Start from 0</button>;
    ...
    it("should show confirmation dialog on reset click", async () => {
      ...
      const component = (
        <div>
          <button data-testid="btn-reset" onClick={() => setShowDialog(true)}>
            Start from 0
          </button>
        </div>
      );
    ...
    it("should cancel reset on dialog cancel", async () => {
      ...
      const dialog = (
        <div data-testid="reset-dialog">
          ...
          <button data-testid="btn-confirm" onClick={onReset}>
            Confirm
          </button>
        </div>
      );
  ...
  describe("PDF Download Actions", () => {
    ...
    it("should handle download error gracefully", async () => {
      ...
      await expect(downloadWithErrorHandling("/api/projects/1/proposal.pdf")).rejects.toThrow(
  ...
  describe("Stage Gating", () => {
    it("should disable stage 2 actions when at stage 1", () => {
      ...
      const button = (
        <button data-testid="btn-assets" disabled={project.currentStage < 2}>
          Generate Assets
        </button>
      );
