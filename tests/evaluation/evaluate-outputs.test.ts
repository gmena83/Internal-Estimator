...
describe("Output Evaluation Tests", () => {
  ...
  describe("PM Breakdown Validation", () => {
    ...
    it("should detect phases without names", () => {
      const breakdown = {
        phases: [{ tasks: [{ name: "Task 1" }], deliverables: ["D1"] }],
      };
    ...
    it("should detect phases without tasks", () => {
      const breakdown = {
        phases: [{ phaseName: "Phase 1", tasks: [], deliverables: ["D1"] }],
      };
    ...
    it("should detect phases without deliverables", () => {
      const breakdown = {
        phases: [{ phaseName: "Phase 1", tasks: [{ name: "Task 1" }], deliverables: [] }],
      };
  ...
  describe("ROI Analysis Validation", () => {
    ...
    it("should have shorter payback for Scenario B", () => {
      ...
      expect(roi.paybackPeriodMonths.scenarioB).toBeLessThan(roi.paybackPeriodMonths.scenarioA);
    });

    it("should have higher 3-year ROI for Scenario B", () => {
      const roi = getMockRoiAnalysis();

      expect(roi.threeYearROI.scenarioB).toBeGreaterThan(roi.threeYearROI.scenarioA);
    });
  });
