...
export const createMockProjectWithEstimate = (): Project => createMockProject({
  currentStage: 2,
...
export const createMockProjectComplete = (): Project => createMockProject({
  currentStage: 5,
  status: 'complete',
  estimateMarkdown: getMockEstimateMarkdown(),
  scenarioA: getMockScenarioA(),
...
export const createMockKnowledgeEntry = (overrides: Partial<KnowledgeEntry> = {}): KnowledgeEntry => ({
...
export const getMockHealthStatus = () => [
  ...
  { service: 'perplexity', displayName: 'Perplexity', status: 'error', latencyMs: 0, requestCount: 1 },
];
